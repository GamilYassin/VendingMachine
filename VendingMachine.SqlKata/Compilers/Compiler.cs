    ...
    public partial class Compiler
    {
        ...
        protected virtual string CompileColumns(SqlResult ctx)
        {
            ...
            var columns = ctx.Query
                .GetComponents<ColumnBase>("select", EngineCode)
        ...
        protected virtual SqlResult CompileDeleteQuery(Query query)
        {
            ...
            var fromClause = ctx.Query.GetOneComponent<FromBase>("from", EngineCode);
        ...
        /// <returns>
        /// </returns>
        public virtual string CompileColumn(SqlResult ctx, ColumnBase column)
        {
        ...
        public virtual string CompileFrom(SqlResult ctx)
        {
            ...
            var from = ctx.Query.GetOneComponent<FromBase>("from", EngineCode);
        ...
        public virtual string CompileGroups(SqlResult ctx)
        {
            ...
            var columns = ctx.Query
                .GetComponents<ColumnBase>("group", EngineCode)
                .Select(x => CompileColumn(ctx, x));
        ...
        {
            var from = join.GetOneComponent<FromBase>("from", EngineCode);
            var conditions = join.GetComponents<ConditionBase>("where", EngineCode);
        ...
        public virtual string CompileOrders(SqlResult ctx)
        {
            ...
            var columns = ctx.Query
                .GetComponents<OrderByBase>("order", EngineCode)
                .Select(x =>
            {
        ...
        public virtual string CompileUnion(SqlResult ctx)
        {
            ...
            var clauses = ctx.Query.GetComponents<CombineBase>("combine", EngineCode);
        ...
        public virtual string CompileWheres(SqlResult ctx)
        {
            ...
            var conditions = ctx.Query.GetComponents<ConditionBase>("where", EngineCode);
        ...
        /// <summary>
        ///  Add the passed operator(s) to the white list so they can be used with the Where/Having
        ///  methods, this prevent passing arbitrary operators that opens the door for SQL injections.
        /// </summary>
        ...
        public virtual string Wrap(string value)
        {
            ...
            {
                var index = value.IndexOf(" as ", StringComparison.InvariantCultureIgnoreCase);
            ...
            // If we reach here then the value does not contain an "AS" alias nor dot "."
            // expression, so wrap it as regular value.
