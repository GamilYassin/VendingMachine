...
{
    public partial class Query : QueryBase<Query>
    {
        #region Fields
        ...
        ///  When true it will search for properties with the [Key] attribute and will add it
        ///  automatically to the Where clause
        /// </param>
        /// <returns>
        /// </returns>
        ...
        ///  Optional, invoked when the condition is false
        /// </param>
        /// <returns>
        /// </returns>
